    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-sm shadow-navy-base/5 border border-navy-light/30 relative overflow-hidden group hover:shadow-md hover:border-navy-base/30 transition-all duration-300">
            ...
            <div class="p-6 sm:p-8">
                <div class="mb-8">
                    <h2 class="text-xl font-bold text-navy-dark font-heading">Form Tambah Mata Pelajaran</h2>
                    <p class="text-sm text-gray-muted mt-1">Lengkapi data-data di bawah ini untuk menambahkan mata pelajaran baru.</p>
                </div>
                ...
                <form action="{{ route('subjects.store') }}" method="POST" class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" placeholder="Contoh: Bahasa Indonesia" required class="w-full bg-white-off/50 border border-navy-light/50 text-navy-dark font-semibold text-sm rounded-xl px-4 py-2.5 focus:bg-white focus:ring-2 focus:ring-navy-base/20 focus:border-navy-base outline-none transition-all">
                        </div>

                        {{-- BARIS 2 --}}
                        {{-- Input Tingkat Kelas (1 Kolom) --}}
                        <div class="md:col-span-1">
                            <label class="block text-sm font-semibold text-navy-dark mb-1.5">Tingkat Kelas (Opsional)</label>
                            <div class="relative">
                        ...
                        <div class="md:col-span-1">
                            ...
                            <input type="number" step="0.01" name="kkm" value="{{ old('kkm') }}" placeholder="Contoh: 75.00" required class="w-full bg-white-off/50 border border-navy-light/50 text-navy-dark font-semibold text-sm rounded-xl px-4 py-2.5 focus:bg-white focus:ring-2 focus:ring-navy-base/20 focus:border-navy-base outline-none transition-all">
                            <p class="text-[10px] text-gray-muted mt-1.5 ml-1">Kriteria Ketuntasan Minimal (0-100)</p>
                        </div>
                    ...
                    <div class="pt-4 border-t border-slate-50 flex items-center justify-end gap-3">
                        <button type="reset" class="px-5 py-2.5 text-sm font-semibold text-navy-dark bg-white-off hover:bg-navy-light/30 border border-navy-light/50 rounded-xl transition-colors flex items-center gap-2">
