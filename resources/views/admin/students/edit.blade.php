...
@section('content')
    <div class="max-w-6xl mx-auto">
        ...
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                <h2 class="text-xl font-bold text-navy-dark font-heading tracking-wide">Ubah Profil Siswa</h2>
                <p class="text-[13px] text-gray-muted mt-0.5 tracking-wide">Perbarui biodata atau sesuaikan email akun login siswa yang bersangkutan.</p>
            </div>
        </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm shadow-navy-base/5 border border-navy-light/30 p-6 h-full flex flex-col">
                        <div class="mb-5 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-[11px] text-gray-muted mt-0.5">Ubah jika ada pembaruan akun</p>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm shadow-navy-base/5 border border-navy-light/30 overflow-hidden p-6 flex flex-col h-full">
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-[11px] text-gray-muted mt-0.5">Ubah jika ada kesalahan penulisan data</p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 flex-grow">
                            ...
                            <div>
                                ...
                                <input type="text" name="phone_number" value="{{ old('phone_number', $student->studentProfile->phone_number ?? '') }}" placeholder="Contoh: 08123456789" required class="w-full bg-white border border-navy-light/40 text-navy-dark text-sm rounded-xl px-4 py-2.5 focus:ring-2 focus:ring-navy-base focus:border-navy-base outline-none transition-all duration-200 shadow-sm font-medium">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="parent_phone" value="{{ old('parent_phone', $student->studentProfile->parent_phone ?? '') }}" placeholder="Contoh: 08123456789" required class="w-full bg-white border border-navy-light/40 text-navy-dark text-sm rounded-xl px-4 py-2.5 focus:ring-2 focus:ring-navy-base focus:border-navy-base outline-none transition-all duration-200 shadow-sm font-medium">
                            </div>
                        </div>
                    </div>
                </div>
