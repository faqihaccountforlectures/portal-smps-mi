    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-300 overflow-hidden relative">
            ...
            <div class="p-6 sm:p-8">
                <div class="mb-8">
                    <h2 class="text-xl font-bold text-navy-dark font-heading">Form Tambah Penugasan</h2>
                    <p class="text-sm text-gray-muted mt-1">
                        Silakan tentukan guru mana yang akan mengajar mata pelajaran apa di kelas mana.
                        <br>
                        Penugasan ini otomatis masuk ke Tahun Ajaran: <b class="text-navy-base">{{ $activeYear->year_name }} ({{ ucfirst($activeYear->semester) }})</b>.
                    </p>
                </div>
                ...
                <form action="{{ route('teacher-assignments.store') }}" method="POST" class="space-y-5">
                    ...
                    <div class="pt-4 border-t border-slate-50 flex items-center justify-between">
                        <a href="{{ route('teacher-assignments.create') }}" class="text-sm font-semibold text-navy-dark hover:text-navy-base transition-colors px-4 py-2 bg-white-off hover:bg-navy-light/30 border border-navy-light/50 rounded-lg">
                            Reset Pilihan
                        </a>
